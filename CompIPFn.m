function [AICminvec, trymatoptrsgridS, optmatS, cdfRmatS, wsolmat,evvec,concvecS]=CompIPFn(choosedata,figures)
...
for a=1:length(concvecS)
    ...
    [~, ~,weightedsol] = RK4FunctionC(optrsgrid, optweight, rho, k, y0, tspanS);
